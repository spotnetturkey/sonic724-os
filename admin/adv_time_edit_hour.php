...
} else  $dlist.="<option value=\"$d\">$d</option>";
...
<p><INPUT type=\"hidden\" NAME=\"sort\" VALUE=\"".($vl)."\" SIZE=5>&nbsp;"
.optionlist("sound","$sound").optionlenght("lenght","$lenght").$dlist.form_button("submit",_ADD,50)
."<p><INPUT type=\"hidden\" NAME=\"csort\" VALUE=\"".($vl)."\" SIZE=5>&nbsp;".optionlist("sound","nosound").$clist.form_button("submit",_ADD_1,50)."<p>
...
if ($value=="nosound")
{
$line="<select class=mydom name=\"$name\"  id=\"$name\" style=\"width:110px;\" disabled>";		
