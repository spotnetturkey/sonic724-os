...
$MENU[br][]=array(_NOW,"adv_time_edit.php?day=".date("w",time())."&h=".date("H:i",time()+120));
$MENU[br][]=array("<hr>","");
$MENU[br][]=array(_DAY1,"adv_time_edit.php?day=1");
$MENU[br][]=array(_DAY2,"adv_time_edit.php?day=2");
$MENU[br][]=array(_DAY3,"adv_time_edit.php?day=3");
$MENU[br][]=array(_DAY4,"adv_time_edit.php?day=4");
$MENU[br][]=array(_DAY5,"adv_time_edit.php?day=5");
$MENU[br][]=array(_DAY6,"adv_time_edit.php?day=6");
$MENU[br][]=array(_DAY0,"adv_time_edit.php?day=0");
$MENU[br][]=array("<hr>","");
$MENU[br][]=array(_WEEKLY_LIST,"adv_weekly_list.php");
$MENU[config][]=array(_CLOSEDTIME,"adv_datetime_config.php");
$MENU[config][]=array(_CHANGEPASSADMIN,"changepassword_admin.php");
$MENU[logout][]=array(_LOGOUT,"logout.php");
...
} else {$sidemenu.="<a href=\"$val1[1]\">&nbsp;&laquo;&nbsp;".$val1[0]."</a>";}
}
